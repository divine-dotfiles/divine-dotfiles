...
Usage: ${bold}${D__EXEC_NAME}${normal} ${bold}c${normal}|${bold}check${normal}   [-ynqvew]  [-b BUNDLE]... [TASK]...  - Check status of deployment(s)
   or: ${bold}${D__EXEC_NAME}${normal} ${bold}i${normal}|${bold}install${normal} [-ynqvewf] [-b BUNDLE]... [TASK]...  - Install deployment(s)
   or: ${bold}${D__EXEC_NAME}${normal} ${bold}r${normal}|${bold}remove${normal}  [-ynqvewf] [-b BUNDLE]... [TASK]...  - Uninstall deployment(s)
