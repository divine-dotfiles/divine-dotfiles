...
#.      __d__dln_hlp__pre_process   - Custom queue pre-processing
#.      __d__dln_hlp__post_process  - Custom queue post-processing
#.  * Executed during installation:
#.      __d__dln_hlp__install_item  - Pre-installation actions for each item
#.  * Executed during removal:
#.      __d__dln_hlp__remove_item   - Pre-removal actions for each item
#
