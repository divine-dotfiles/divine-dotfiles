...
#
## This is an annotated example of a deployment using the copy-queue helpers.
#
## The copy-queue takes a list of asset paths, a list of destination paths, 
#. and sequentially copies the former onto the latter. No overwriting is done, 
#. although this can be influenced. The stashing system is used to track the 
#. installations of the copy-queue.
#
