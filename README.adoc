...
.com/divine-dotfiles/divine-dotfiles/master/lib/install/install.sh; if curl --\
...
raw.github.com/divine-dotfiles/divine-dotfiles/master/lib/uninstall/uninstall.\
