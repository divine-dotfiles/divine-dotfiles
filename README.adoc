...
[source,bash]
----
# Install framework without prompts;
...
This command: installs the framework without prompts; attaches the https://github.com/no-simpler/divine-bundle-essentials[`essentials`] bundle of deployments to your Grail directory; installs the deployments.
