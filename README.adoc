...
:revnumber: 34
:revdate: 2019.08.21
:revremark: Improve wording in joy ride effect description
:doctype: article
// Visual
:toc:
// Subs:
...
| `*config-shell*/`
| All shell startup scripts (runcoms) are here.

| `*config-{as}*/`
| Global configs for `git` and `vim` are here.

Look under respective `config-{as}/` dirs.

| *&dagger;* `*fonts*/`
| Dump your personal font files into this dir.

Promptly install them everywhere you take your Grail.

| *&dagger;* `*home-dirs*/`
| In `home-dirs.cfg`, set up a sub-directory tree.

It will be maintain under `$HOME` on all your machines.
...
*&dagger;* `*oh-my-zsh*/`
| Custom shell framework assets are here.

| `*portable-bin*/`
| This is your go-to dir for custom shell commands.

They will be maintained on your `$PATH`.
