...
:revnumber: 62
:revdate: 2019.09.02
:revremark: Demote queue array notes to normal paragraphs
:doctype: article
// Visual
:toc:
// Subs:
...
This function is called once per queue processing, before checking begins.
...
This function is called once per queue processing, after checking is completed.
...
This function is called once, immediately before <<func-queue-item-install,installing>> the symlink.
...
This function is called once, immediately before <<func-queue-item-remove,uninstalling>> the symlink.
...
This function is called once per link queue processing, before checking begins.
...
This function is called once per link queue processing, after checking is completed.
...
This function is called once, immediately before <<func-queue-item-install,copying>>.
...
This function is called once, immediately before <<func-queue-item-remove,removing>> the copy.
...
This function is called once per copy queue processing, before checking begins.
...
This function is called once per copy queue processing, after checking is completed.
