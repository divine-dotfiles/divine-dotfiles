...
:revdate: 2019.12.04
:revremark: Improve readme to paint a better pic of fmwk
:doctype: article
// Visual
:toc: macro
// Subs:
...
The Grail contents are carried across OS's and installed/removed using _Divine.dotfiles_.
...
The Github repositories containing deployments are treated as bundles that can be attached with one <<rtn-attach,command>>. One example is the associated <<divine-bundles,Divine bundle>> https://github.com/divine-bundles/essentials[`essentials`].
...
//raw.github.com/divine-dotfiles/divine-dotfiles/dev/lib/install/install.sh\
...
github.com/divine-dotfiles/divine-dotfiles/dev/lib/uninstall/uninstall.sh; \
