...
:revdate: 2019.11.12
:revremark: Update readme for D.d v2, pt. 9
:doctype: article
// Visual
:toc: macro
// Subs:
...
+
The built-in OS detection mechanisms facilitate writing portable deployments.
...
But wait, there's _(hopefully)_ more.
...
All of the above is controlled and customized through key configuration files located under the <<fmwk-grail,Grail directory>> at `~/.divine/grail/assets/`.
