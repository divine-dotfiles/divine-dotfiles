...
The Github repositories containing deployments are treated as bundles that can be attached with one command, e.g., the https://github.com/divine-bundles/essentials[`essentials`] bundle.
...
The Divine bundles are published to the Gighub page: https://github.com/divine-bundles.
...
| +++<p align="center">+++
`*https://github.com/divine-bundles/primers[Secure handler of GnuPG and SSH keys]*`
+++</p>+++

_(fully functional on macOS, not yet fully documented)_

Automates adherence to best security practices while handling secret keys to

* https://www.gnupg.org[GnuPG].
* https://en.wikipedia.org/wiki/Secure_Shell[SSH].
...
A collection of configuration maintainers for:

* https://code.visualstudio.com[Visual Studio Code].
* https://hyper.is[Hyper] terminal.
* https://transmissionbt.com[Transmission BT].

This collection is intended to grow.
