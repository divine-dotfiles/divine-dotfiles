...
:revnumber: 54
:revdate: 2019.09.02
:revremark: Test new table layout, pt. 5
:doctype: article
// Visual
:toc:
// Subs:
...
*'Unknown'*: [.gray]##_(default)_## no reliable way to tell whether this deployment is installed or not.
...
*'Installed'*: as it stands, intended goal of installing this deployment is entirely achieved.
...
*'Not installed'*: as it stands, intended goal of installing this deployment is entirely not achieved.
...
*'Irrelevant'*: processing this deployment in current environment does not make sense.
...
*'Partly installed'*: as it stands, intended goal of installing this deployment is partly achieved and partly not achieved.
...
*'Reboot needed'*: same as 'Successfully installed', except:
...
*'User attention needed'*: same as 'Successfully installed', except:
...
*'Critical failure'*: same as 'Failed to install', except:
...
*'Reboot needed'*: same as 'Successfully uninstalled', except:
...
*'User attention needed'*: same as 'Successfully uninstalled', except:
...
*'Critical failure'*: same as 'Failed to uninstall', except:
