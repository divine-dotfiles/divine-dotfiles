...
:revdate: 2019.11.15
:revremark: Improve joy ride wording in readme
:doctype: article
// Visual
:toc: macro
// Subs:
...
The following single shell command:
...
All three commands *skip* the trivial <<fmwk-interactivity,prompts>> (e.g., 'Are you sure?').

The *result* of the installation is summarized in the <<fmwk-joy-ride-sum,next section>>.
The *undo* command is also <<fmwk-joy-ride-undo,provided>>.
