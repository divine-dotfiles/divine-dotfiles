...
:revnumber: 32
:revdate: 2019.08.21
:revremark: Add divine dpls; improve anchors; refine
:doctype: article
// Visual
:toc:
// Subs:
...
<<divine-deployments,*Divine deployments*>> (distributed separately), such as the https://github.com/no-simpler/divine-dpls-core[core bundle], strive to exemplify what a good deployment should look like.
...
Divine deployments are deployments developed and distributed by the author of _Divine.dotfiles_.
